            ...
            Column(
                ...
                Row(
                    ...
                    DownloadButton(
                        ...
                        onClick = {
                            window.open("https://drive.google.com/uc?export=download&id=1ly921hk-9zldcimtnL-i3uys88Sj_NvQ")
                        }
                    )
                    DownloadButton(
                        text = "Download MSI",
                        ...
                        onClick = {
                            window.open("https://drive.google.com/uc?export=download&id=1_XWfENgqwfUAHOf2l7o6R34bri2pVYYt")
                        }
                    )
                }
            }
